package com.blair.blairspring.repositories.jdbc;
...
public class JobRepositoryJdbc {
    ...
    public Job findById(Long id) {
        return jdbcTemplate.queryForObject("SELECT id, dscr AS description FROM jobs WHERE ID = ?", new Object[]{id}, new BeanPropertyRowMapper<>(Job.class));
    }
